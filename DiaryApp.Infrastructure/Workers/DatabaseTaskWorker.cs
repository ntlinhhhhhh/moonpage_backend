...
public class DatabaseTaskWorker : BackgroundService
{
    ...
    public DatabaseTaskWorker(IServiceProvider serviceProvider, IOptions<RabbitMQSettings> options, ILogger<DatabaseTaskWorker> logger)
    {
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        await using (channel)
        {
            await channel.QueueDeclareAsync("db_tasks_queue", true, false, false, cancellationToken: stoppingToken);
            ...
            await channel.BasicConsumeAsync("db_tasks_queue", false, consumer, cancellationToken: stoppingToken);
            ...
            {
                _logger.LogInformation("DatabaseTaskWorker is stopping...");
            }
        }
    }
}